...
**
** Created: Thu Jul 31 10:38:03 2014
...
static const char qt_meta_stringdata_Viewer[] = {
    "Viewer\0\0slot_itemSelectionChanged()\0"
    "slot_reset_click()\0"
};
...
void *Viewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_Form"))
        return static_cast< Ui_Form*>(const_cast< Viewer*>(this));
...
int Viewer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: slot_itemSelectionChanged(); break;
        case 1: slot_reset_click(); break;
        default: ;
        }
        _id -= 2;
    }
